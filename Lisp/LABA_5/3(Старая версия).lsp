;ключевое слово   ;нужное слово
(define (task3 keyword word)
	(if (empty? keyword)
		"empty"
		(Func (parse (nth 0 (inSentence keyword 0))"-") (parse (nth 0 (inSentence word 0))"-"))	
	)
)
...
(define (Func lstkeyword lstword)
...
(task3 '(("транспорт")) '(("ясли")))
(task3 '(("искусство")) '(("кукушка")))